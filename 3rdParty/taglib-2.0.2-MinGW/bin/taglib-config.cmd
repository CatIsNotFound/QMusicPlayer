...
:doit
if /i "%1#" == "--libs#"    echo -LD:/CPPLibs/taglib/lib -llibtag
if /i "%1#" == "--cflags#"  echo -ID:/CPPLibs/taglib/include -ID:/CPPLibs/taglib/include/taglib
if /i "%1#" == "--version#" echo 2.0.2
if /i "%1#" == "--prefix#"  echo D:/CPPLibs/taglib
